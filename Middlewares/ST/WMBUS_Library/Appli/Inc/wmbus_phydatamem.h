...
#define METER_DB_LENGTH         26
#define METER_ID_ENCRY_LEN      25
#define MAX_NUM_OF_MTR          10
#define ENCRYPTION_KEY_LEN      16
#define METER_ID_LEN            8   
#define METER_1                 0
#define METER_2                 1
#define METER_3                 2
#define METER_4                 3
 ...
 *@}
 */
extern uint8_t EEpromMtrData[METER_DB_LENGTH];
extern uint8_t aMETER_Enkey_DB[METER_DB_LENGTH];

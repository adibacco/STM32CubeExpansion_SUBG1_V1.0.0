...
* @version V1.0.8
* @date    24-Jul-2014
* @brief  This file contains header for wmbus_linkServices.c
*
******************************************************************************
* @attention
*
...
/** @addtogroup wmbus_linkServices         WMBus LinkServices
...
/** @addtogroup WMBus_LinkServices_Exported_Types          WMBus LinkServices Exported Types
* @{
*/
/**
* @brief  WMBus Link Primary Services enum definition.The PRM bit in C field is 1.
*/
typedef enum 
{
...
/**
* @brief  WMBus Link Secondary Services enum definition.The PRM bit in C field is 0.
*/
typedef enum 
{
...
/**
* @brief  WMBus Link Services Last event enum definition.
*/
typedef enum
{
...
/**
* @brief  WMBus Link Services Current Link State enum definition.
*/
typedef enum
{
...
/**
* @brief  WMBus Link Service type enum definition.
*/
typedef enum 
{
...
typedef struct 
{
  ...
  Frame_t   frame;/*!< The frame contains attributes and payload; */
} Request_t;
...
typedef struct 
{
  ...
  SpiritBool   positive;/*!< The Ackpositive-> S_TRUE/Nack(positive-> S_FALSE); */
  LINK_SERVICE_TYPE_t  serviceType;/*!< The service type attribute; */
  Frame_t                frame;/*!< The frame contains attributes and payload; */
} Confirmation_t;
...
/** @defgroup WMBus_LinkServices_Exported_Constants        WMBus LinkServices Exported Constants
* @{
*/
...
/** @defgroup WMBus_LinkServices_Exported_Macros           WMBus LinkServices Exported Macros
* @{
*/
...
/** @defgroup WMBus_LinkServices_Exported_Functions        WMBus LinkServices Exported Functions
* @{
*/
/**
...
* @param  1) Request_t *request - A pointer to a Request primitive contains retry counter, attributes and payload.
...
*                       
*/
extern LINK_STATUS WMBus_LinkServicesRequestsCallbackMode(Request_t *request, void (*ApplliTxDataHandler)(LINK_STATUS,LastEventLog_t LastEvent));
/**
...
* @param  1) Indication_t *indication - A pointer to a Indication primitive contains attributes and payload.
*         2) void (*WMBus_AppliIndicaCallback)(Indication_t*, LastEventLog_t)
...
*                       
*/
extern LINK_STATUS WMBus_LinkServicesIndicationCallbackMode(Indication_t *indication, void (*WMBus_AppliIndicaCallback)(Indication_t*, LastEventLog_t));
/**
* @brief  TThis function attempts to transmit the response to the indication frame received.
* @param  1) Indication_t* indication - A pointer to the received link layer indication service primitive.
*         2) Response_t* response     - A pointer to a link layer response service primitive.
...
*                       
*/
LINK_STATUS WMBus_LinkServicesResponseCallbackMode(Indication_t *pIndication, Response_t *pResponse, void (*WMBus_AppliIndicaCallback)(LINK_STATUS,LastEventLog_t));
...
* @}
*/
uint8_t WMBus_LinkServicesGetTxFcb(AMFR_ATTR  m_field, ADDR_ATTR a_field,\
  SpiritBool toggle);
SpiritBool WMBus_LinkServicesGetFcvEnabled(uint8_t c_field);
void WMBus_LinkServicesGetResponseDelay10Us(uint32_t* pMin, uint32_t* pMax,\
  uint32_t *pPreambleDelay);
void WMBus_LinkServicesRxDataHandler(Frame_t *frame);
void WMBus_LinkServicesTxDataHandler(LINK_STATUS status);
